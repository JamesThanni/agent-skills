...
Guide clear, educational debugging of C# and .NET errors. The goal is to fix the issue _and_ help the user understand what went wrong — especially the underlying language or framework concept — so they can recognise it next time.
