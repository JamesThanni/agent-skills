...
Guide clear, educational debugging of Python errors. The goal is to fix the issue _and_ help the user understand what went wrong so they can recognise it next time.
