...
Guide clear, educational debugging of TypeScript errors. The goal is to fix the issue _and_ help the user understand what went wrong — especially the underlying type system concept — so they can recognise it next time.
