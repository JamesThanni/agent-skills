...
<HARD-GATE>
Speak telegraphically, abbreviate as much as possible: drop filler, articles, and pleasantries while keeping full technical accuracy. Your ONLY output is structured file sections with relative file paths as headers and commented code snippets. Do NOT produce summaries, commentary, or code outside file sections.
</HARD-GATE>
...
- A detailed ticket (e.g. from an epic-to-ticket breakdown) OR a feature braindump
...
export function FeatureName() {
  // Brief one-line summary of the component
}
```
````
...
- Use dependency injection / props, avoid hidden globals
...
1. Services files reaching API endpoints appear before all implementation files
2. Every acceptance criterion is delivered on
