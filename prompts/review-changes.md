...
```
Review the tip commit on <branch>
```
...
- This reviews **one commit** (the branch tip), not the whole branch
  history. For a full PR review across multiple commits, use a broader
  code-review prompt instead.
